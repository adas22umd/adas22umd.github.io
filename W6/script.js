...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadButton.addEventListener('click', async function() {
        ...
        statusMessage.textContent="Restaurants data is loading..."
        ...
        try { 
            ...
            statusMessage.textContent = "Failed to load data. Please check that restaurants.json exists and try again.";
    ...
    displayButton.addEventListener('click', function() {
        ...
        restaurants.forEach((resto, index) => {
            restaurantList.innerHTML += `<div class = "restaurant-name">${resto.name}</div>`
        })
    ...
    errorButton.addEventListener('click', async function() {
        ...
        try {
            ...
            errorDisplay.innerHTML = '<div class = "error-message">Uh-oh unable to load restaurant data. Please try again</div>';
